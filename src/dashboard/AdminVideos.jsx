        ...
        <div className="admin-table-wrapper">
          ...
          <tbody>
            {filtered.map((v) => (
              <tr key={v.id}>
                <td>
                 <img className="article-image" src={v.thumbnail_url} alt={v.title}/>
                </td>

                <td><span className="article-title"> {v.title} </span></td>

                <td>{v.category}</td>

                <td>{v.views}</td>

                <td><span className={`article-status ${v.status}`}>{v.status}</span></td>
