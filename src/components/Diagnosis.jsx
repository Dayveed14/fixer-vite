      ...
      <div className="diag">
        ...
        <form
          ...
          <div className="diag__actions">
            <button type="button" className="diag__btn diag__btn--skip">
              Skip
            </button>
            <button
              type="submit"
        ...
        {showModal &&
          ...
          (() => {
            ...
            const estimatedNaira = diagnosis.estimatedRepair
              ? Number(
                  String(diagnosis.estimatedRepair).replace(/[^0-9.]/g, ""),
                ) * USD_TO_NAIRA
              : 0;
            ...
            return (
              <div
                ...
                <div
                  ...
                  {diagnosis.source === "knowledge_base" &&
                  diagnosis.results?.length > 0 ? (
                      ...
                      <div className="diag-modal-header">
                        <div className="diag-modal-icon">
                          <svg
                            ...
                            fill="none">
                            <path
                              d="M14.7 6.3a4 4 0 00-5.6 5.6L3 18v3h3l6.1-6.1a4 4 0 005.6-5.6l-2.5 2.5-2-2 2.5-2.5z"
                              stroke="currentColor"
                              strokeWidth="1.6"
                              strokeLinejoin="round"
                            />
                        ...
                        <div>
                          <span className="diag-modal-eyebrow">
                            Diagnosis result
                          </span>
                          <h2>
                        ...
                        return (
                          <div key={issue.id} className="diag-result">
                            ...
                            <div className="diag-stat-row">
                              ...
                              <div className="diag-stat">
                                <svg
                                  ...
                                  fill="none">
                                  <path
                                    d="M5 8h14M5 8a2 2 0 01-2-2V5a1 1 0 011-1h16a1 1 0 011 1v1a2 2 0 01-2 2M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8"
                                    stroke="currentColor"
                                    strokeWidth="1.6"
                                    strokeLinejoin="round"
                                  />
                              ...
                              <div className="diag-section">
                                <h4>
                                  <svg
                                    ...
                                    fill="none">
                                    <path
                                      d="M9 11l3 3L22 4M12 19a7 7 0 100-14 7 7 0 000 14z"
                                      stroke="currentColor"
                                      strokeWidth="1.7"
                                      strokeLinecap="round"
                                      strokeLinejoin="round"
                            ...
                            <p className="diag-followup">
                              Still stuck? Take it a step further — talk to our
                              technical support team or send your device in for
                              repair.
                            </p>
                            ...
                            <div className="diag-modal-actions">
                              <button
                                ...
                                <svg
                                  ...
                                  fill="none">
                                  <path
                                    d="M4 12a8 8 0 0116 0v4a2 2 0 01-2 2h-1v-6h3M4 16v-4a8 8 0 0116 0"
                                    stroke="currentColor"
                                    strokeWidth="1.7"
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                    ...
                    <div className="diag-ai-result">
                      ...
                      <div className="diag-result">
                        ...
                        <p className="diag-followup">
                          This diagnosis was generated using AI based on the
                          symptoms you provided. If the issue persists, we
